...
export const NotFound: React.FC = () => {
  return (
    <div className="py-32 px-4 text-center bg-[#F8F8F6] text-[#101828] min-h-[70vh] flex items-center justify-center">
      <div className="max-w-md mx-auto p-10 rounded-sm bg-white border border-[#D9DEE5] shadow-editorial">
        <h1 className="text-8xl font-serif font-bold text-[#071A33] mb-4 tracking-wider">404</h1>
        <h2 className="text-2xl font-serif font-bold text-[#071A33] mb-3">Page Not Found</h2>
