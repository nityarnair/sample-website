...
<div className="rounded-[20px] border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl p-8 sm:p-12 lg:p-14 mb-16 lg:mb-20">
  <div className="mb-8 pb-6 border-b border-white/10">
    <span className="text-[11.5px] font-mono font-bold text-blue-400 uppercase tracking-widest block mb-1">
      Route 01
    </span>
  ...
  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
    ...
    <div className="lg:col-span-6 space-y-4">
      ...
      <div className="p-6 rounded-[16px] bg-blue-500/10 border border-blue-400/30 backdrop-blur-md">
        <div className="mb-2 text-blue-200 font-bold text-sm font-sans">
...
<div className="p-8 sm:p-12 lg:p-14 bg-white/5 backdrop-blur-xl text-white rounded-[20px] border border-white/10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 shadow-2xl">
  <div>
    <span className="text-[11px] font-mono font-bold text-blue-400 uppercase tracking-widest block mb-2">
