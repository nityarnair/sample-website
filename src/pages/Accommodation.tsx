  ...
  return (
    <div className="py-20 sm:py-28 bg-[#F8F8F6] text-[#101828] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="bg-[#071A33] border border-white/10 text-white rounded-container p-8 sm:p-12 mb-16 flex flex-col md:flex-row items-center justify-between gap-8 shadow-editorial">
          ...
          <a
            ...
            className="px-7 py-3.5 text-xs font-sans uppercase tracking-[0.14em] font-semibold bg-white text-[#071A33] hover:bg-[#EFF6FF] rounded-full transition-all flex items-center gap-2 shrink-0 shadow-pill"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="rounded-container p-8 bg-white border border-[#D9DEE5] shadow-subtle flex flex-col justify-between hover:border-[#12345B]/40 hover:shadow-editorial transition-all">
            <div>
              ...
              <h4 className="font-serif text-2xl text-[#071A33] mb-3">
        ...
        <div className="rounded-container p-8 sm:p-12 bg-white border border-[#D9DEE5] text-center shadow-subtle">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#EFF6FF] text-[#2563EB] mb-4">
            <Info className="w-6 h-6" />
          </div>
          <h4 className="font-serif text-2xl sm:text-3xl text-[#071A33] mb-2">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#F8F8F6] border border-[#D9DEE5] hover:border-[#12345B] text-[#071A33] text-xs sm:text-sm font-semibold transition-all font-mono"
          >
