    ...
    <div className="py-20 sm:py-28 bg-[#F8F8F6] text-[#101828] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="bg-[#071A33] border border-white/10 text-white rounded-container p-8 sm:p-12 mb-16 flex flex-col md:flex-row items-center justify-between gap-8 shadow-editorial">
          <div>
            <span className="inline-flex items-center gap-1.5 text-xs font-sans font-bold uppercase tracking-[0.16em] text-[#93C5FD] bg-white/10 px-3.5 py-1.5 rounded-full mb-4 border border-white/15">
          ...
          <div className="flex flex-wrap gap-4 shrink-0">
            <a
              ...
              className="px-7 py-3.5 text-xs font-sans uppercase tracking-[0.14em] font-semibold bg-white text-[#071A33] hover:bg-[#EFF6FF] rounded-full transition-all flex items-center gap-2 shadow-pill"
            >
          ...
          <div className="lg:col-span-5">
            ...
            <div className="space-y-3">
              {CONFERENCE_DATA.importantDates.map((item, idx) => (
                <div
                  key={idx}
                  className="bg-white border border-[#D9DEE5] rounded-xl p-5 flex items-center justify-between shadow-subtle"
                >
