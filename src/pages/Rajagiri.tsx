    ...
    <div className="py-20 sm:py-28 lg:py-32 bg-[#F7F7F4] text-[#101828] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <PageHeader
          number="01"
          category="RAJAGIRI"
          metaRight="Kalamassery, Kochi · Autonomous · Estd. 1955"
        ...
        {/* ── HERO INSTITUTIONAL EDITORIAL COMPOSITION ── */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-20 lg:mb-28">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between">
            <div>
              ...
              <h2 className="text-[2.25rem] sm:text-[2.75rem] font-serif font-normal text-[#071A33] leading-[1.1] mb-6">
                A Legacy of Distinction &amp; Social Commitment
              </h2>

              <p className="text-base sm:text-[1.0625rem] text-[#667085] leading-relaxed font-sans font-normal mb-5">
                Rajagiri College of Social Sciences (Autonomous), Kalamassery, established in 1955 by the Carmelites of Mary Immaculate (CMI) Congregation, is one of India&apos;s premier institutions for higher education. Guided by its motto, <em className="text-[#071A33]">Relentlessly Towards Excellence</em>, the college has built a legacy of academic distinction, innovation, and social commitment.
              </p>

              <p className="text-base sm:text-[1.0625rem] text-[#667085] leading-relaxed font-sans font-normal mb-8">
        ...
        {/* ── UNBOXED EDITORIAL STATISTICS ── */}
        <div className="py-10 border-y border-[#D9DEE5] mb-20 lg:mb-28">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            {stats.map((stat, idx) => (
              <div key={idx} className="group">
                <div className="font-serif text-[2.25rem] sm:text-[2.75rem] font-semibold text-[#071A33] leading-none mb-1 tabular-nums group-hover:text-[#2563EB] transition-colors">
                  {stat.value}
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mb-20 lg:mb-28 items-start">
          
          {/* Recognitions List (6 cols) */}
          <div className="lg:col-span-6">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-full bg-white border border-[#D9DEE5] flex items-center justify-center text-[#2563EB] shadow-subtle">
                <Award className="w-5 h-5" />
              </div>
              <h3 className="font-serif text-[1.75rem] sm:text-[2.1rem] text-[#071A33] font-normal m-0">
            ...
            <div className="space-y-4">
              {recognitions.map((item, idx) => (
                <div key={idx} className="flex items-start gap-3 p-4 rounded-[16px] bg-white border border-[#D9DEE5] shadow-subtle">
                  <CheckCircle2 className="w-4 h-4 text-[#2563EB] mt-0.5 shrink-0" />
                  <span className="text-xs sm:text-sm font-sans font-medium text-[#071A33] leading-snug">
                    {item}
                  </span>
                </div>
              ))}
          ...
          <div className="lg:col-span-6">
            ...
            <div className="p-8 sm:p-10 rounded-[24px] bg-white border border-[#D9DEE5] shadow-editorial space-y-6">
              <div>
                <span className="text-[11px] font-mono font-bold uppercase tracking-[0.18em] text-[#2563EB] block mb-2">
                  Times Higher Education Impact Rankings
                </span>
                <h4 className="font-serif text-2xl sm:text-3xl text-[#071A33] font-normal mb-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="lg:col-span-6 p-8 sm:p-12 lg:p-14 flex flex-col justify-between order-2 lg:order-1">
              <div>
                ...
                <p className="text-sm sm:text-base text-[#667085] leading-relaxed font-sans font-normal mb-4">
                ...
                <p className="text-sm sm:text-base text-[#667085] leading-relaxed font-sans font-normal mb-0">
        ...
        <div className="mb-20 lg:mb-28 rounded-[24px] p-8 sm:p-12 lg:p-14 border border-[#D9DEE5] bg-white shadow-editorial">
          ...
          <p className="text-[#667085] text-sm sm:text-base leading-relaxed mb-8 font-sans font-normal">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs sm:text-sm text-[#101828]">
            <div className="flex items-start gap-3 p-5 rounded-[16px] bg-[#F7F7F4] border border-[#D9DEE5]">
              <CheckCircle2 className="w-4 h-4 text-[#2563EB] mt-0.5 shrink-0" />
        ...
        <div className="text-center bg-[#071A33] text-white border border-white/10 rounded-[24px] p-10 sm:p-14 shadow-editorial">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-white/10 text-white mb-5 border border-white/15">
            <Building2 className="w-7 h-7" />
          </div>
          <h3 className="font-serif text-[2rem] sm:text-[2.75rem] mb-3 font-normal">
