  ...
  return (
    <div className="py-20 sm:py-28 bg-[#F8F8F6] text-[#101828] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="text-center bg-[#071A33] text-white border border-white/10 rounded-container p-12 shadow-editorial">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-white text-[#071A33] hover:bg-[#EFF6FF] font-sans font-semibold text-xs tracking-[0.14em] uppercase shadow-pill transition-all"
          >
