      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-base text-[#667085] font-sans font-normal mt-4 m-0 leading-relaxed">
            Registration opens on <strong>10 August 2026</strong>. All registrations include full access to keynote sessions, plenary panels, track-wise presentations, conference kits, and luncheon on both days.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14">
          {CONFERENCE_DATA.fees.map((fee, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`bg-white border rounded-container p-8 sm:p-10 flex flex-col justify-between transition-all duration-300 ${
                  isFeatured
              ...
              >
                {isFeatured && (
                  <div className="absolute -top-3.5 left-8 bg-[#071A33] text-white text-[10px] uppercase tracking-[0.18em] font-sans font-bold px-3.5 py-1 rounded-full shadow-subtle">
                    Recommended
                  </div>
                )}

                <div>
                  <span className="block text-xs font-sans uppercase tracking-[0.16em] text-[#667085] font-bold mb-2">
                    Category {idx + 1}
                  </span>
                  
                  <h3 className="font-serif text-2xl text-[#071A33] mb-4 min-h-[3.5rem] leading-snug">
                    {fee.category}
                  </h3>

                  <div className="flex items-baseline gap-1 mb-8 pb-6 border-b border-[#D9DEE5]">
                    <span className="font-serif text-4xl sm:text-5xl text-[#071A33] font-normal">
                      {fee.amount}
                    </span>
                  ...
                  <ul className="space-y-3.5 text-xs sm:text-sm text-[#101828]/85 font-sans mb-10">
                ...
                <a
                  ...
                  className={`group w-full py-3.5 h-[50px] inline-flex items-center justify-center gap-2 text-xs font-sans uppercase tracking-[0.14em] font-semibold rounded-full transition-all ${
                    isFeatured
        ...
        {/* Bank Details Note */}
        <div className="bg-white border border-[#D9DEE5] rounded-container p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-subtle">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-[#EFF6FF] border border-[#BFDBFE] flex items-center justify-center text-[#2563EB] shrink-0">
              <CreditCard className="w-5 h-5" />
            </div>
            <div>
              <h4 className="font-serif text-lg text-[#071A33] mb-0.5">
